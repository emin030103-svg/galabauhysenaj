...
<main id="main">
    <section class="page-hero">
      <div class="hero-media"><picture><source srcset="assets/images/pflasterarbeiten.webp" type="image/webp"><img src="assets/images/pflasterarbeiten.jpg" alt="Pflasterarbeiten" width="1600" height="1200" fetchpriority="high"></picture></div>
    ...
    <section class="section section-muted gallery-system"><div class="container section-head"><div><p class="eyebrow">Bilder</p><h2>Passende Eindrücke</h2></div></div><div class="container gallery-grid service-gallery"><a class="gallery-item" href="assets/images/pflasterarbeiten.jpg" data-lightbox data-gallery-card data-category="pflasterarbeiten" data-caption="Pflasterarbeiten - Projektbild">
          ...
          <span>Pflasterarbeiten - Projektbild</span>
        </a>
